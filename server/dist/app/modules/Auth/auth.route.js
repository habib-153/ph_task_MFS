...
router.post('/register', multer_config_1.multerUpload.single('image'), bodyparser_1.parseBody, (0, validateRequest_1.default)(auth_validation_1.AuthValidation.registerValidationSchema), auth_controller_1.AuthControllers.registerUser);
